...
$(function () {
			...
			var $button = $('<button>Check my results!</button>').addClass('btn btn-primary').attr('type', 'button');
			$div.append($button);

			//........... CHECK RESULTS ...........
			$button.on('click', function (event) {

						var userWeight = [{ number: 0, weight: [] }, { number: 1, weight: [] }, { number: 2, weight: [] }, { number: 3, weight: [] }, { number: 4, weight: [] }, { number: 5, weight: [] }, { number: 6, weight: [] }];
