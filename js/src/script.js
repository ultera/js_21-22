"use strict";
    ...
    const lStok = "js1314sourceTest";

    $(function() {
	//........... LOCALSTORAGE ..............
	let sourceTest = JSON.stringify(iqtest.prepareTestData());
	...
	//........... BUTTON ..............
	let $div = $('<div></div>').appendTo($container).addClass('button');
	let $button = $('<button>Check my results!</button>')
	...
	for(let i = 0; i < iqtest.getObjectLength(sourceTest); i++) {

    	    for (let j = 0; j < iqtest.getObjectLength(sourceTest[i].answers); j++) {
	...
	let userResult = iqtest.countResult(sourceTest, userWeight);
